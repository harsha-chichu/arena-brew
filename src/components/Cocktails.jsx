  ...
  return (
    <section id="cocktails" className="py-24 md:py-36 relative overflow-hidden" ref={ref}>
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 80% at 50% 50%, rgba(26,191,174,0.05) 0%, transparent 70%)
          `,
        }}
      />
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {cocktails.map((c, i) => (
            <motion.div
              ...
              className="group relative bg-bg-card border border-white/5 hover:border-white/10 transition-all duration-500 p-8 md:p-10 overflow-hidden"
            >
              {/* Background glow on hover */}
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"
                style={{
                  background: `radial-gradient(ellipse at 50% 80%, ${c.color}12 0%, transparent 65%)`,
                }}
              />
